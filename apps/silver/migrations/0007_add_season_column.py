...
DROP_SEASON_SQUAD = """
ALTER TABLE silver.squad_snapshot DROP COLUMN season;
"""

DROP_SEASON_SCOUTING = """
ALTER TABLE silver.scouting_snapshot DROP COLUMN season;
"""

DROP_SEASON_MATCHSTATS = """
ALTER TABLE silver.squad_matchstats_snapshot DROP COLUMN season;
"""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("silver", "0006_alter_silveringestion_status_and_more"),
    ]
